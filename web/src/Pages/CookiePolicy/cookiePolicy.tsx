  ...
  return (
    <div className="cookie-container">
      ...
      <div className="cookie-body-container">
            ...
            <Row justify="center">
              <Col span={20}>
                <div className="cookie-body">
                  ...
                  <br /> The specific types of first and third party cookies
                  served through our Websites and the purposes they perform are
                  described below
                  <br /> (please note that the specific cookies served may vary
            ...
            <Row justify="center">
              <Col span={20}>
                <div className="cookie-body">
                  ...
                  <br /> The Cookie Consent Manager can be found in the
                  ...
                  <br /> In addition, most advertising networks offer you a way
                  to opt out of targeted advertising. If you would like to find
        ...
        <Row>
          <Col sm={24} md={24} lg={24}>
            <div className="cookie-card-subtitle">
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        in Java™ 2 Platform Enterprise Edition web applications.
                        <br /> It is a necessary cookie that expires at the end
                        of a session.
                      </td>
                    </tr>
                    <tr>
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a
                          target="_blank"
                          href="https://www.novomotus.com/privacy-policy/"
                        >
                          View Service Privacy Policy
                        </a>{" "}
                      </td>
                ...
                <div className="cookie-card-container">
                  <table>
                    ...
                    <tr>
                      <td>Purpose:</td>
                      <td>
                        Facebook tracking pixel used to identify visitors for
            ...
            <Row justify="center">
              <Col span={20}>
                <div className="cookie-body">
                  ...
                  <br /> If you do not want Flash Cookies stored on your
                  computer, you can adjust the settings of your Flash player to
                  ...
                  <br /> Please note that setting the Flash Player to restrict
            ...
            <Row justify="center">
              <Col span={20}>
                <div className="cookie-body">
                  ...
                  <br /> The date at the top of this Cookie Policy indicates
            ...
            <Row justify="center">
              <Col span={20}>
                <div className="cookie-body-contact">
                  ...
                  technologies, please email us at digital@undp.org or by post
                  to:
                  <br />
                  <br />
                  <br />
